package com.yk.silenct.datepicker.dialog;
...
import com.yk.silenct.datepicker.util.ConvertUtils;
...
public abstract class ConfirmDialog<V extends View> extends BaseDialog<View> {
    ...
    protected View makeHeaderView() {
        ...
        cancelButton.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/montserrat_medium.ttf"));
        ...
        submitButton.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "fonts/montserrat_medium.ttf"));
